...
import com.mayur.urlshortener.dto.ShortenerDTO;
import com.mayur.urlshortener.entity.ShortenerPOJO;
import com.mayur.urlshortener.repository.ShortenerRepository;
import org.springframework.stereotype.Service;
import com.mayur.urlshortener.service.Base62Conversion;
        ...
        if (isValidURL(request.getLongUrl()))
        {
           ...
           // System.out.println("value of entity size is ="+entity1.getId());
            ...
            if(entity1 == null)
                ...
                System.out.println("Mayur just before save");
                System.out.println("Mayur id is this========>"+url.getId());
